...
#pick random number to be guessed from 1 to 10
...
print("If your guess is within 7 of my number, I'll tell you you're WARM")
...
while True:
    ...
    if guesses[-2]:
        if abs(num-guess) < abs(num-guesses[-2]):
            ...
            print('Colder')
    #check if guess is within range of 5
    else:
        if abs(num-guess) <=5:
            print('Warm')
        else:
